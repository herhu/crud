...
describe('EccService', () => {
  ...
  beforeEach(async () => {
    process.env.ECC_PUBLIC_KEY =
      '259fc0db122179dee2ecc37606962c15337302031c46bf8ec10adba068a1a939';
    process.env.ECC_PRIVATE_KEY =
      '0515fd0b312d40a61463e949b3ce7f5c204d030711a12518d774f3d604a79b4b';
